...
class MODELARGS:
    def __init__(self):
        ...
        self.start_epoch = 399
        self.unetmodel = f"{self.save_path}/399.pth"
        ...
        self.batch_size = 6; self.epochs=600; self.lr = 0.0002
args = MODELARGS()
from davisdataloader import DAVISMosegLoader, DAVISMosegLoader
